...
export class TaskService {
  ...
  activateTask(container: string, taskid: string, user?: string): void {
    ...
    this.http.put<any[]>(url, {headers: this.getHeaders(), params})
      .subscribe(res => {
        console.error('Task Activated ', res);
      });
  }
  ...
  claimTask(container: string, taskid: string, user?: string): void {
    ...
    this.http.put<any[]>(url, {headers: this.getHeaders(), params})
      .subscribe(res => {
        console.error('Task Claimed ', res);
      });
  }
  ...
  startClaimedTask(container: string, taskid: string): void {
    ...
    this.http.put<any[]>(url, {headers: this.getHeaders(), params})
      .subscribe(res => {
        console.error('Start Claimed Task', res);
      });
  }

  completeClaimedTask(container: string, taskid: string,
                      parentRequest: CaseRequest): Observable<any> {
    ...
    return new Observable<any>(obs => {
      ...
      if (parentRequest.closeCase) {
        ...
        // @ts-ignore
        const body = {
          'closeCase': parentRequest.closeCase,
  ...
  delegate(containerId, taskid: string, caseid: string): void {
    ...
    this.http.put<any[]>(url, {headers: this.getHeaders()})
      .subscribe(res => {
        this.userManagement.sendNotification(caseid, UserDetails.delegateUser);
      });
  }
